...
- **Upload and browse photos.**  Upload single, or multiple at a time.
...
- **New Photo Editor** let you make non-destructive crop and dithering edits to fine tune your photos.
- When uploading a single file, you can immediately edit and crop your upload on mobile or desktop before it hits the server, or edit any iamge on disk.
- Nice Quality of Life upgrades to make the photo management process more fluid and useful.
